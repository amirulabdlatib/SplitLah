...
export default function RegisterPage() {
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }} className="w-full max-w-sm">
            ...
            {/* Google button */}
            <Button type="button" variant="outline" className="w-full h-11 rounded-xl border-border font-medium gap-3 hover:bg-muted transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] mb-6 hover:cursor-pointer">
